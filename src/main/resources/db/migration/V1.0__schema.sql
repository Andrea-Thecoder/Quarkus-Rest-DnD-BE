...
create table a_personaggio_spell_book (
  id                            uuid not null,
  personaggio_id                uuid not null,
  spell_book_name               bigint not null,
  _version                      bigint not null,
  _data_creazione               timestamptz not null,
  _data_modifica                timestamptz not null,
  _utente_creazione             varchar(255) not null,
...
create table spell_book (
  ...
  _utente_creazione             varchar(255) not null,
  _utente_modifica              varchar(255) not null,
  constraint uq_spell_book_personaggio_id_spell_name unique (personaggio_id,spell_name),
...
create table tipo_classe (
  ...
  constraint uq_tipo_classe_description unique (description),
...
create table tipo_equipaggiamento (
  id                            bigint generated by default as identity not null,
  description                   varchar(255) not null,
  constraint uq_tipo_equipaggiamento_description unique (description),
...
create table tipo_razza (
  id                            bigint generated by default as identity not null,
  description                   varchar(255) not null,
  constraint uq_tipo_razza_description unique (description),
...
alter table a_personaggio_spell_book add constraint fk_a_personaggio_spell_book_spell_book_name foreign key (spell_book_name) references spell_book (id) on delete cascade on update restrict;

create index ix_spell_book_personaggio_id on spell_book (personaggio_id);
alter table spell_book add constraint fk_spell_book_personaggio_id foreign key (personaggio_id) references anagrafica_personaggio (id) on delete cascade on update restrict;
